...
const projects = {
  ...
  "quantum-oscillator": {
    ...
    visualType: "qosc-viz",
    summary: "Pending-publication paper deriving the 3D isotropic quantum oscillator analytically and validating it as a molecular model for group 6 hexafluorides — UF₆, WF₆, MoF₆ — by matching radial distribution peaks to measured bond lengths. Co-authored with Dr. Douglas A. Barlow, Sewanee.",
    overview: "This paper derives and applies the three-dimensional isotropic quantum harmonic oscillator as a molecular model for group 6 hexafluorides (UF₆, WF₆, MoF₆) — highly symmetric molecules with Oh octahedral geometry. Beginning from the time-independent Schrödinger equation, the radial component is separated in spherical coordinates and shown to satisfy the associated Laguerre equation, yielding energy eigenvalues E = ℏω(2n + l + 3/2) and wavefunctions indexed by principal quantum number n and angular momentum l. The objective is to determine whether a single oscillator state can reproduce known X-F bond lengths without a full many-electron treatment.",
    ...
    bullets: [
      ...
      "Oh octahedral symmetry — group 6 hexafluorides UF₆, WF₆, MoF₆",
